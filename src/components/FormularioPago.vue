    ...
    <div class="window">
      <div class="order-info">
        <div class="order-info-content">
          ...
          <table style="width:50%"
            ...
            :key="index"
            class="order-table line"
          >
            <tbody>
              <tr>
                <td><img :src="item.poster" class="full-width" /></td>
                <td>
                  <br />
                  <span class="thin">{{ item.titulo }}</span>
                </td>
              </tr>
              <tr>
                <td>
      ...
      <div class="credit-info">
        <div class="credit-info-content">
          ...
          <button class="pay-btn" @click="finalizarCompra()">Checkout</button>
        </div>
      </div>
    </div>
  </div>
